...
//Undefined
/*
Undefinted usually means a variable has been declared, but it's not be assigned a value
*/
...
/*
Null and undefined both represent varialables with no value inside. Think of is this way--null values are for gag gifts that are boxes intentionally given with nothing inside (because that's the gag).
Undefinted values are gifts given when the person giving the gift has forgotten to put the gift inside (oops)
...
Denoted by []
Has vlues of ('blue', 'green', 'yellow'), separated by commas
*/
